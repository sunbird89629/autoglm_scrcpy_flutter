...
import 'package:scrcpy_plus/src/mcp_http_server.dart';
...
class _TestEnv {
  _TestEnv({List<String>? devices})
    ...
    server = ScrcpyPlusServer(session: session, adb: adb);
  }

  final MockAdb adb;
  final MockScrcpySession session;
  late final ScrcpyPlusServer server;
...
void main() {
  group('ScrcpyPlusServer — initialization', () {
  ...
  group('ScrcpyPlusServer — resources', () {
  ...
  group('ScrcpyPlusServer — prompts', () {
  ...
  group('ScrcpyPlusServer — recording', () {
