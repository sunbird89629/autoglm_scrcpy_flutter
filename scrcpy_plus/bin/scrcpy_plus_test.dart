#!/usr/bin/env dart
// Test client for scrcpy_plus — exercises all MCP capabilities.
...
Future<void> main(List<String> args) async {
  ...
  stdout.writeln('=== scrcpy_plus Test Client ===\n');

  // Workspace root = current working directory.
  final workspaceRoot = Directory.current.path;
  final serverPath = '$workspaceRoot/scrcpy_plus/bin/scrcpy_plus.dart';
  ...
  final client = McpClient(
    const Implementation(name: 'scrcpy-plus-test', version: '0.1.0'),
  );
